$(document).ready(function(){
    ...
    loadcart();
     ...
     /*Функция строчного и плиточного вида*/
...
$("#select-sort").click(function(){
    ...
    /*Видимый или зашифрованный пароль*/
    ...
    /*Проверка введенных данных в окно авторизации*/
...
if (auth_pass == "" || auth_pass.length > 15 )
 ...
 { 
  ...
  }else
  {
    ...
    /*При нажатии на кнопку "Забыли пароль?" открыть окно восстановления пароля, при нажатии кнопки "Назад" вернуть окно авторизации*/
...
$('#prev-auth').click(function(){
    ...
    /*Проверка e-mail в окне восстановления пароля*/
...
function loadcart(){
 ...
 function fun_group_price(intprice) {  
  ...
  groupprice = result_total;  
    ...
    /*Уменьшение и увеличение количества товаров в корзине*/
...
function  itog_price(){
 ...
 $.ajax({
  ...
  $(".itog-price > strong").html(data);
    ...
    /*Проверка формы отправки отзыва*/
