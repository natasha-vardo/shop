...
<?php 
	...
	$count = mysqli_query($connect,"SELECT COUNT(*) FROM table_products WHERE visible = '1'");
	...
	$query_start_num = " LIMIT $start, $num"; 
        ...
        $result = mysqli_query($connect,"SELECT * FROM table_products WHERE visible='1' ORDER BY $sorting $query_start_num");
