...
<?php 
   ...
   /* $num = 6; // Указываем сколько хотим выводить товаров
	...
	$count = mysqli_query($connect,"SELECT COUNT(*) FROM table_products WHERE visible = '1' $querycat");
	...
	$query_start_num = " LIMIT $start, $num"; 
        ...
        $result = mysqli_query($connect,"SELECT * FROM table_products WHERE visible='1' $querycat ORDER BY $sorting $query_start_num");
