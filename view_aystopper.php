...
<?php 
	...
	$count = mysqli_query($connect,"SELECT COUNT(*) FROM table_products $query_aystopper");
	...
	{ 
        ?>
            ...
            <p id="nav-breadcrums"><a href="index.php">Главная страница </a><span>\ <?php echo $name_aystopper; ?></span></p>
            <ul id="option-list">
                <li>Вид: </li>
...
<?php   
            /*Вывод товара*/
        $result = mysqli_query($connect,"SELECT * FROM table_products $query_aystopper ORDER BY $sorting $query_start_num");
